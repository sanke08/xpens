...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, TextInput, SafeAreaView, Platform, KeyboardAvoidingView } from 'react-native';
          ...
          {categories.map((c) => {
            ...
            return (
              <View key={c.id} style={styles.row}>
                <View style={[styles.iconBox, { backgroundColor: isIncome ? '#dcfce7' : '#f5f5f5' }]}>
